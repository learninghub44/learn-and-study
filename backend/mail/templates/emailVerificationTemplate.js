...
const otpTemplate = (otp, name) => {
	...
	<body>
		<div class="container">
			<img class="logo"
					src="https://i.ibb.co/7Xyj3PC/logo.png" alt="Learn & Study Logo">
			<div class="message">OTP Verification Email</div>
			<div class="body">
				<p>Dear ${name}</p>
				<p>Thank you for registering with Learn & Study. To complete your registration, please use the following OTP
